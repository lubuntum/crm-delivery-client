...
export const getOrdersBetweenDates = async (startDate, endDate, token) => {
    return axios.get(`${SERVER_URL}${GET_ORDERS_BETWEEN_DATES}?startDate=${startDate}&endDate=${endDate}`, {
        headers: {Authorization: token}
    })
}